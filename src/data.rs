...
const ZWIPE: Project = Project {
    ...
    media: &[
        ...
        MediaItem {
            src: asset!("/assets/projects/zwipe/2_deck_cards.mp4"),
            alt: "Browsing cards with keywords, full details, art, and printings",
            caption: Some("Browse cards: keywords, full details, art, and printings"),
            kind: MediaKind::Video,
        },
        MediaItem {
        ...
        MediaItem {
            src: asset!("/assets/projects/zwipe/4_filter.mp4"),
            alt: "Filtering the card pool then swiping to add",
            caption: Some("Filter the card pool, then swipe to add"),
            kind: MediaKind::Video,
        },
        MediaItem {
            src: asset!("/assets/projects/zwipe/5_profile.mp4"),
            alt: "Switching themes from the profile",
            caption: Some("Switch themes from your profile"),
            kind: MediaKind::Video,
        },
    ],
    approach: &[

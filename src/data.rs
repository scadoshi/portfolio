...
const ZWIPE: Project = Project {
    ...
    media: &[
        MediaItem {
            ...
            caption: Some("Creating a new deck"),
            kind: MediaKind::Video,
        },
        MediaItem {
            src: asset!("/assets/projects/zwipe/2_add_deck_cards.mp4"),
            alt: "Swiping cards to add to a deck",
            caption: Some("Swiping cards to add to a deck"),
            kind: MediaKind::Video,
        },
        MediaItem {
            src: asset!("/assets/projects/zwipe/3_deck_cards_view.mp4"),
            alt: "Browsing the deck card list",
            caption: Some("Browsing the deck card list"),
            kind: MediaKind::Video,
        },
        MediaItem {
            src: asset!("/assets/projects/zwipe/4_register.mp4"),
            alt: "Creating a Zwipe account",
            caption: Some("Creating a Zwipe account"),
            kind: MediaKind::Video,
        },
        MediaItem {
